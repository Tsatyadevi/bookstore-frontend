...
const ShowBooks = () => {
  ...
  useEffect(() => {
    setLoading(true);
    axios
      .get(`https://bookstore-backend-lnse.onrender.com/books/${id}`)
  ...
  }, []); // Run the effect when the id parameter changes
    ...
    <div className='p-4'>
      ...
      {loading ? (
        ...
        <div className='flex flex-col border-2 border-sky-400 rounded-x1 w-fit p-4'>
          ...
          <div className='my-4'>
            <span className='text-x1 mr-4 text-gray-500'>Last updated Time</span>
